...
- **Cookiecutter Variables**:
  ...
  - `https://github.com/ByronWilliamsCPA/rag-processor` - Download location
...
- **Cookiecutter Variables**:
  ...
  - `rag_processor` - Project slug for repo name
- **Features**:
...
| `https://github.com/ByronWilliamsCPA/rag-processor` | auto | Derived from github info | REUSE.toml, mkdocs.yml |
| `https://rag-processor.readthedocs.io` | auto | Derived from project_slug | mkdocs.yml |
...
- **ingestion**: PDF/Image Ingestion module (`src/rag_processor/ingestion/**`)
- **detection**: IQA Detection module (`src/rag_processor/detection/**`)
- **correction**: Image Correction module (`src/rag_processor/correction/**`)
- **output**: JSON Output module (`src/rag_processor/output/**`)
- **utils**: Utilities module (`src/rag_processor/utils/**`)
