...
git remote add origin https://github.com/ByronWilliamsCPA/rag-processor.git
...
3. **Enter your repository URL**: `https://github.com/ByronWilliamsCPA/rag_processor`
...
3. **Get your project key**: Should be `ByronWilliamsCPA_rag_processor`
...
2. **Security Contact**: Change `security@williamscpa.dev` if needed
