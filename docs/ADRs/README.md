...
This directory contains Architecture Decision Records (ADRs) that document important architectural and design decisions made in RAG Processor.
...
**Reference**: This ADR process is based on [Nygard's ADR format](https://github.com/adr/adr-template) with modifications for RAG Processor.
