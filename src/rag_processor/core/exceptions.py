"""Centralized exception hierarchy for RAG Processor.
...
class ProjectBaseError(Exception):
    """Base exception for all RAG Processor errors.
...
def http_status_for(exc: ProjectBaseError) -> int:
    ...
    Args:
        exc (ProjectBaseError): The project exception instance.

    Returns:
        int: The HTTP status code to return for this exception.
    """
