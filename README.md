...
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=ByronWilliamsCPA_rag_processor&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=ByronWilliamsCPA_rag_processor)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=ByronWilliamsCPA_rag_processor&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=ByronWilliamsCPA_rag_processor)
...
[![PyPI Publish](https://github.com/ByronWilliamsCPA/rag_processor/actions/workflows/publish-pypi.yml/badge.svg)](https://github.com/ByronWilliamsCPA/rag_processor/actions/workflows/publish-pypi.yml)
...
| **Created** | 2025-12-04 |
| **Repository** | [ByronWilliamsCPA/rag-processor](https://github.com/ByronWilliamsCPA/rag-processor) |
...
```bash
# Start backend first
uv run uvicorn rag_processor.main:app &
...
# Run with coverage
uv run pytest --cov=rag_processor --cov-report=html
...
uv run pytest --cov=rag_processor --cov-report=term-missing
...
uv run pytest --cov=rag_processor --cov-fail-under=80
```
