...
class TestContextVariableFunctions:
    ...
    def test_get_correlation_id_default_none(self) -> None:
        ...
        from rag_processor.middleware.correlation import (
            get_correlation_id,
        )
    ...
    def test_get_trace_id_default_none(self) -> None:
        ...
        from rag_processor.middleware.correlation import get_trace_id
    ...
    def test_get_span_id_default_none(self) -> None:
        ...
        from rag_processor.middleware.correlation import get_span_id
...
class TestModuleExports:
    ...
    def test_all_functions_exported(self) -> None:
        ...
        from rag_processor.middleware import correlation
