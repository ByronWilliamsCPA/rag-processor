...
RAG Processor exception hierarchy, covering:
...
class TestProjectBaseError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from rag_processor.core.exceptions import ProjectBaseError
...
class TestValidationError:
    ...
    def test_basic_initialization(self) -> None:
        """Verify basic initialization with message only."""
        from rag_processor.core.exceptions import ValidationError
...
class TestResourceNotFoundError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from rag_processor.core.exceptions import ResourceNotFoundError
...
class TestAuthenticationError:
    ...
    def test_default_message(self) -> None:
        ...
        from rag_processor.core.exceptions import AuthenticationError
...
class TestAuthorizationError:
    ...
    def test_default_message(self) -> None:
        """Verify default message is used when not provided."""
        from rag_processor.core.exceptions import AuthorizationError
...
class TestExternalServiceError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from rag_processor.core.exceptions import ExternalServiceError
...
class TestAPIError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from rag_processor.core.exceptions import APIError
...
class TestDatabaseError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from rag_processor.core.exceptions import DatabaseError
...
class TestBusinessLogicError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from rag_processor.core.exceptions import BusinessLogicError
...
class TestModuleExports:
    ...
    def test_all_exceptions_exported(self) -> None:
        ...
        from rag_processor.core import exceptions
