...
- `rag_processor/path/to/file.ext`
...
`rag_processor/.github/workflows/`.

**Affected Files**:
- `rag_processor/.github/workflows/ci.yml`
- `rag_processor/.github/workflows/release.yml`
- `rag_processor/.github/workflows/docs.yml`
